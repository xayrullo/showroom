<template>
  <div class="p-[72px] grid grid-cols-4 gap-0">
    <RouterLink
      :to="{
        path: '/products',
        query: {
      ...
      v-for="(category, ind) in data"
      :key="ind"
    >
      <div
        class="cursor-pointer group opacity-90 hover:opacity-100 transition-opacity duration-1000"
      >
        <img
          class="w-[100%]"
          :src="IMAGE_URL + category.image.source_url"
